...
$Referer_check_domain = "www.kattsu.com";
...
$require = array('名前','Email','お問い合わせ内容');
...
<?php if($empty_flag == 1){ ?>
<div align="center">
<h4>不正リクエスト入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</h4>
...
<div align="center">
<?php if($empty_flag == 1){ ?>
<h4>不正リクエスト 入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</h4>
...
//確認画面無しの場合の表示、指定のページに移動する設定の場合、エラーチェックで問題が無ければ指定ページヘリダイレクト
	...
	if($empty_flag == 1){ ?>
<div align="center"><h4>不正リクエスト 入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</h4><div style="color:red"><?php echo $errm; ?></div><br /><br /><input type="button" value=" 前画面に戻る " onClick="history.back()"></div>
<?php 
